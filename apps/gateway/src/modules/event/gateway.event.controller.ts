...
import { FindEventListRequest, FindEventListResponse, FindEventResponse } from './dto/find.event.dto';
...
export class GatewayEventController {
    ...
    @ApiResponse({ status: 200, description: '[ADMIN, OPERATOR] 이벤트 조회', type: FindEventListResponse })
    async findEvents(@Body() body: FindEventListRequest) {
